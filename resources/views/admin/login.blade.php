...
<div class="container mx-auto">
   ...
   <div class="flex justify-center items-center h-screen">
    <div class="flex flex-col items-center gap-1">
        <form class="max-w-md mx-auto bg-black/70 shadow-xl p-5 rounded-sm" action="{{route('admin.loginpost')}}" method="POST">
            @csrf
            ...
            <div class="flex justify-start items-center gap-5">
                ...
                <a class="underline text-blue-500 text-sm" href="{{route('admin.show')}}">Not Register?</a>
            </div>
          </form>
          @if (session('status'))
